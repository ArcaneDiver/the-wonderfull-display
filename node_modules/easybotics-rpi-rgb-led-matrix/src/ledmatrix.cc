...
{
	//return Nan::ThrowTypeError("gayy");
	LedMatrix* matrix = ObjectWrap::Unwrap<LedMatrix>(args.This());
	...
	//return Nan::ThrowTypeError("che leggenda");
	...
	uv->speed = speed;
	//return Nan::ThrowTypeError("che leggenda2");
	matrix->Ref();
	//return Nan::ThrowTypeError("che leggenda3");

	uv_work_t* w = new uv_work_t;
	w->data = uv;
	//return Nan::ThrowTypeError("che leggenda4");
	//qui avviene la segmentation fault
	int r = uv_queue_work(uv_default_loop(), w, UV_Scroll, UV_AfterScroll);
	return Nan::ThrowTypeError("che leggenda5");
